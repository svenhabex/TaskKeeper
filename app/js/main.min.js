...
var Tasks = function () {
  var tasks = ["Taak 1 maken", "Modular javascript"];

  //cacheDom
  var addForm = document.querySelector("#add-input");
  var addButton = addForm.querySelector("button");
  var addInput = addForm.querySelector("#add");
  ...
  function _render() {
    taskList.innerHTML = tasks.map(function (task, i) {
      return "<li class=\"task\" data-id=\"" + i + "\">" + task + "<span><svg style=\"width:24px;height:24px\" viewBox=\"0 0 24 24\">\n    <path class=\"x\" fill=\"#000000\" d=\"M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z\" />\n    </svg></span></li>";
    }).join("");
  }
  ...
  function deleteTask(e) {
    var remove = e.target.closest(".task").dataset.id;
    tasks.splice(remove, 1);
    _render();
  }

  function searchTask(e) {
    var tasksArr = Array.from(document.querySelectorAll(".task"));
